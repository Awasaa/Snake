...
void display_logo (ALLEGRO_BITMAP *logo, ALLEGRO_FONT *font, uint16_t width, uint16_t high)
{
...
void display_info (ALLEGRO_BITMAP *logo, ALLEGRO_FONT *font, uint16_t width, uint16_t high)
{
...
void display_menu (ALLEGRO_BITMAP *menu, ALLEGRO_FONT *titulo, ALLEGRO_FONT *opciones, uint16_t width, uint16_t high)
{
    ...
    al_draw_text (titulo, al_map_rgb(0,0,0), width/2, high/10,ALLEGRO_ALIGN_CENTRE, "SNAKE");
    al_draw_text (opciones, al_map_rgb(0,0,0), width/2, high/2,ALLEGRO_ALIGN_CENTRE, "Jugar");
    al_draw_text (opciones, al_map_rgb(0,0,0), width/2, high*6/10,ALLEGRO_ALIGN_CENTRE, "Mejores puntajes");
    al_draw_text (opciones, al_map_rgb(0,0,0), width/2, high*7/10,ALLEGRO_ALIGN_CENTRE, "Opciones");
    al_draw_text (opciones, al_map_rgb(0,0,0), width/2, high*8/10,ALLEGRO_ALIGN_CENTRE, "Creditos");
    al_flip_display();
    al_rest(3.0);
